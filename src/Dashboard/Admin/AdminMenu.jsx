...
const AdminMenu = () => {
    return (
        <div>
            ...
            <li><NavLink to='/dashboard/postBlogAdmin'><BiSolidDonateHeart /> Add Blogs </NavLink></li>
            ...
            <li><NavLink to='/dashboard/allPaymentHistory'><MdOutlineCurrencyExchange className='text-xl' /> All Payment History</NavLink></li>
