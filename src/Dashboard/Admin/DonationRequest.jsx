...
//             case 'done':
//                 return 'bg-green-600'; // Green text color
//             case 'canceled':
//                 return 'bg-red-600'; // Red text color
//             case 'inprogress':
//                 return 'bg-lime-400'; // Lime-400 text color
//             case 'pending':
//                 return 'bg-yellow-600'; // Blue text color
//             default:
//                 return ''; // Default color (if none of the above)
//         }
//     };
...
//                     </thead>
//                     <tbody>
//                         {filteredDonationRequests.map((data, index) => {
...
//                                                     if (result.isConfirmed) {
//                                                         try {
//                                                             await axiosPublic.delete(`/deleteDonationRequest/${data._id}`);
//                                                             Swal.fire({
//                                                                 title: "Deleted!",
