...
const UpdateDonationRequest = () => {
    ...
    const dataToBeUpdated = useLoaderData();
    ...
    const onSubmit = async (formData) => {
        try {
            ...
            if (res.data.success) {
                ...
                console.log('Sending request to update with data:', requestInfo);

                const res2 = await axiosPublic.patch(`/donationRequests/update/${dataToBeUpdated?._id}`, { requestInfo });
                ...
                if (res2.data.modifiedCount) {
                    Swal.fire({
                        position: "center",
                        icon: "success",
                        title: "Your update work has been saved",
                        showConfirmButton: false,
                        timer: 1500
                    });
                    navigate('/dashboard/manageDonationRequestDonor')
                }
            }
        } catch (error) {
    ...
    return (
        <div className="mb-10">
            <form onSubmit={handleSubmit(onSubmit)} className="card-body ml-2 rounded-xl border-4 border-blue-400 p-6 mx-auto">
                <h1 className="text-4xl font-bold text-center pb-8 border-b-4 border-red-600">Update Your Donation Request Here</h1>
                ...
                <div className="border-2 border-yellow-300 p-6">
                    ...
                    <div className="form-control">
                        ...
                        <input type="text" {...register("recipientName", { required: true })} defaultValue={dataToBeUpdated?.recipientName} className="input input-bordered " />
                    ...
                    <div className="form-control">
                        ...
                        <select {...register("bloodGroup", { required: true })} defaultValue={dataToBeUpdated?.bloodGroup} className="input input-bordered">
                    ...
                    <div className="form-control">
                        ...
                        <select {...register("district", { required: true })} defaultValue={dataToBeUpdated?.district} value={selectedDistrict} onChange={(e) => setSelectedDistrict(e.target.value)} className="input input-bordered">
                    ...
                    <div className="form-control">
                        ...
                        <select {...register("upazila", { required: true })} defaultValue={dataToBeUpdated?.upazila} value={selectedUpazila} onChange={(e) => setSelectedUpazila(e.target.value)} className="input input-bordered">
                    ...
                    <div className="form-control">
                        ...
                        <input type="text" {...register("hospitalName", { required: true })} defaultValue={dataToBeUpdated?.hospital} placeholder="like: Dhaka Medical College Hospital" className="input input-bordered " />
                    ...
                    <div className="form-control">
                        ...
                        <input type="text" {...register("fullAddress", { required: true })} defaultValue={dataToBeUpdated?.address} placeholder="like: Zahir Raihan Rd, Dhaka" className="input input-bordered " />
                    ...
                    <div className="form-control">
                        ...
                        <input type="text" {...register("time", { required: true })} defaultValue={dataToBeUpdated?.time} placeholder="Time, like 10am or 5pm" className="input input-bordered mb-3" />
                    ...
                    <div className="form-control">
                        ...
                        <textarea type="text" {...register("requestMessage", { required: true })} defaultValue={dataToBeUpdated?.requestMessage} className="input input-bordered textarea " placeholder="Request Message"></textarea>
                        {errors.requestMessage && <span className='text-red-600'>This field is required</span>}
                    </div>
                </div>

                <div className="form-control mt-6">
                    <input className="btn btn-primary" type="submit" value="Update Request" />
                </div>
            </form>
